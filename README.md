...
**▶ Play online:** https://tylersweatt.github.io/Test-Repository-/
...
The repo ships with `.github/workflows/pages.yml`, which republishes the site on every push
to `main` (it can also be triggered manually from the Actions tab via *Run workflow*).
Pages is configured under Settings → Pages with **GitHub Actions** as the source.
